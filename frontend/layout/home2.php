...
<!--<![endif]-->
  ...
  ?>
  <body id="translation" class="<?=$strClassPage; ?> <?= isset($url_data[0]) && $url_data[0] == $seo_name["page"]["search"] ? "page-search":null ?> lang-<?=$langcode?>" data-add-class-active-to-obj="li.menu-item-<?=$strPageId?>,active" data-fixed="#header + .space-header" data-fixed-class="has-fixed" <?php echo $strValidateExp; ?>>
      <?=$strElementBodytop?>
      <div class="website" <?=$attributeOfWebsiteBlock?> >
        <?php
        require dirname(__FILE__) . '/top/header2.php';
        require dirname(__FILE__) . '/container/main2.php';
      ...
      <?php
        ...
        echo isset($scriptStyle["javascript"]) && !is_array($scriptStyle["javascript"]) ? $scriptStyle["javascript"]:null;
      ?>
