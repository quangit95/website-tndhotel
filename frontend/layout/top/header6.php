            ...
            <div class="col-xs-12 col-sm-10 col-md-9">
                ...
                foreach ($menuStructure as $key => $value) {
                    ...
                    if(isset($value["sub"]) && $value["sub"]) {
                        ...
                        $strMenu .='<li '.$strCustomMenuTemplate.' class="menu-item menu-item-'.$value["id"].'"><a href="'.$link.'" data-goto-top data-obj="#page-id-'.$value["id"].'">'.$value["ti"].' <i class="fa fa-angle-down"></i></a>'.$strSubMenu.'</li>';
                        $stroption .= '</optgroup>';
                    }
                    else {
                        $stroption .= '<option value="'.$link.'">'.$value["ti"].'</option>';
                        $strMenu .='<li '.$strCustomMenuTemplate.' class="menu-item menu-item-'.$value["id"].'"><a href="'.$link.'" data-goto-top data-obj="#page-id-'.$value["id"].'">'.$value["ti"].'</a></li>';
                    }
                }
