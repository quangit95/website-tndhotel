...
<!--<![endif]-->
  ...
  ?>
<body id="translation" class="<?=$strClassPage; ?> lang-<?=$langcode?>" data-add-class-active-to-obj="li.menu-item-<?=$strPageId?>,active" data-fixed="#header + .space-header" data-fixed-class="has-fixed">
    <div id="map"></div>
    <div class="website">
      <?php
      require dirname(__FILE__) . '/../portal/header.php';
      # require dirname(__FILE__) . '/../portal/menu.php';
      require "frontend/menu.php";
