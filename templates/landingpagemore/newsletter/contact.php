...
$strSubjectRow = isset($infoUpdate["su"]) && !empty($infoUpdate["su"]) ? "<p><strong>{$language["subject"]}:</strong> {$infoUpdate["su"]}</p>" : null;

$strEmailFrom = isset($infoUpdate["em"]) && !empty($infoUpdate["em"]) ? "<p><strong>{$language["email"]}:</strong> {$infoUpdate["em"]}</p>":null;

$strAddress = isset($infoUpdate["add"]) && !empty($infoUpdate["add"]) ? "<p><strong>{$language["address"]}:</strong> {$infoUpdate["add"]}</p>":null;

$strFullname = isset($infoUpdate["fn"]) && !empty($infoUpdate["fn"]) ? "<p><strong>{$language["fullname"]}:</strong> {$infoUpdate["fn"]}</p>":null;

$strYourNumber = isset($infoUpdate["ph"]) && !empty($infoUpdate["ph"]) ? "<p><strong>{$language["yourNumber"]}:</strong> {$infoUpdate["ph"]}</p>":null;

$strYourMessage = isset($infoUpdate["me"]) && !empty($infoUpdate["me"]) ? "<p><strong>{$language["content"]}:</strong> {$infoUpdate["me"]}</p>":null;
