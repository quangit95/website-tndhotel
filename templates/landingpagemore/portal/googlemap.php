    ...
    <div class="col-xs-12 col-md-4 hidden-xs hidden-sm">
        <ul id="home-location" style="height: 480px; overflow: scroll;">
            ...
            foreach ($productList as $key => $value) {
                if(isset($value["lng"]) && count($value["lng"]) && isset($value["lat"]) && count($value["lat"]) && $value["st"]>1) {
                    ...
                    <div class="msm-content">
                        <div class="msm-content-detail">
                            ...
                            <div class="location">
                                <?php
                                $strCity = null;
                                if(isset($value["ci"]) && count($value["ci"])) {
                                ...
                                if($price["sale"]) {
                                    echo '<p>'.$language["price"].': <span'.$formatCurrency.' class="price-main">'.$price["sale"].'</span></p>';
                                }
                                ?>
                            </div>
