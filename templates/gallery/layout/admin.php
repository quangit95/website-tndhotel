...
<!--<![endif]-->
  ...
  $socialSkype = isset($social["skype"]) && strval($social["skype"]) ? "skype:{$social["skype"]}?chat" : "skype:webbac1?chat";
  $socialFacebook = isset($social["facebook"]) && strval($social["facebook"]) ? $social["facebook"] : "https://facebook.com";
  ...
  <body data-tinymce-menubar="true">
    <div class="admin-page">
        ...
        <div id="footer">
            <div class="container">
                <p class="copyright">CMS được phát triển bởi <a href="#"><strong class="text-uppercase"><?=$language["siteby"]?></strong></a> - <a href="tel:0944112199"> <span class="icon-phone"></span> hỗ trợ khách hàng 0944112199</a></p>
            </div>
        </div>
    </div>
