...
<!--<![endif]-->
  ...
  ?>
  <body id="translation" class="<?=$strClassPage;?> <?= isset($url_data[0]) && $url_data[0] == $seo_name["page"]["search"] ? "page-search":null ?> lang-<?=$langcode?>" data-add-class-active-to-obj="li.menu-item-<?=$strPageId?>,active" data-fixed="#header + .space-header" data-fixed-class="has-fixed" >
      <?=$strElementBodytop?>
      <div class="website" <?=$attributeOfWebsiteBlock?> >
        <?php
        require dirname(__FILE__) . '/top/header.php';
