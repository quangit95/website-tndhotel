...
if(!empty($listCatChild)) {
    foreach ($listCatChild as $key => $value) {
        ...
        $strShowCat .= '<div class="item-view-products '.$tmpCustomclassName.'"
                ...
                data-init-button-magic=".item [data-button-magic]" '.$strCustomMenuTemplate.' 
...
if(isset($pageInfo["more"]["itemTemplate"]) && !empty($pageInfo["more"]["itemTemplate"]) ){
    $strItemTemplate["product"] = $pageInfo["more"]["itemTemplate"];
} elseif( isset($pageInfoParent["more"]["itemTemplate"]) && !empty($pageInfoParent["more"]["itemTemplate"])  ) {
    $strItemTemplate["product"] = $pageInfoParent["more"]["itemTemplate"];
}
...
if(isset($pageInfo["more"]["contentCustom"]) && !empty($pageInfo["more"]["contentCustom"])) {
    ...
    <div class="item-view-products  <?=$customclassName?>"
        ...
        data-init-object="<?=$strLocalListItem?>"
        data-filter-init='<?=$strFilter?>' <?=$strCustomMenuTemplate?>
