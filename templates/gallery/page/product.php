...
if($isPageNotFound) {
    ...
    function main() {
        ...
        if(isset($itemInfomation["more"]["content"]) && $itemInfomation["more"]["content"]) {
            $strFormatDetailProduct = '{3} <div class="description-info product-detail product-detail-layout">
                <div class="row">
                    <div class="col-xs-12 col-sm-6 col-right">
                        {12}
                    </div>
                    <div class="col-xs-12 col-sm-6">
                        <div class="info info-product-top">
                            {4}{8}{5}{6}{7}
                        </div>
                        {9}
                    </div>
            ...
            <div class="description">{10}{18}{19}{11}{13}</div>{14}{15}{16}{17}';
        } else {
            $strFormatDetailProduct = '
            {3}
            <div class="description-info product-detail product-detail-layout">
                {4}
                <div class="row">
                    <div class="col-xs-12 col-sm-12 col-right">
                        {12}
                    </div>
                    <div class="col-xs-12 col-sm-12 init-none productdetail-info">
                        <div class="info info-product-top">
                            {8}{5}{6}{7}
                        </div>
                        {9}
